...
public class shifumiRulesView extends JFrame {
	...
	public shifumiRulesView() {
		...
		JLabel lblNewLabel3 = new JLabel("Chaque joueur choisi simultanément entre pierre feuille et ciseaux :");
		lblNewLabel3.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel3.setBounds(28, 124, 599, 53);
		contentPane.add(lblNewLabel3);
		
		JLabel lblNewLabel4 = new JLabel(" - La pierre bat le ciseau.");
		...
		JLabel lblNewLabel5 = new JLabel(" -  Le ciseau bat la feuille.");
